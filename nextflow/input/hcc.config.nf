// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/HCC-Exome"
includeConfig "$projectDir/input/wes_tumor_only_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/HCC/Exome"
params.input = "$projectDir/input/manifests/hcc_exome.csv"
...
params.ref = ["genome": genome,
              ...
              "cnkvit_reference": "/data/project/stemcell/shannc/output/WES_PON/cnvkit_reference/4-all_normals-CnvkitPrep_reference.cnn",
