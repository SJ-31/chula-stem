// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/CRC-RNASEQ"
includeConfig "$projectDir/input/rnaseq_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/CRC/RNASEQ"
if (params.debug) {
    params.input = "$projectDir/input/manifests/crc_rnaseq_DEBUG.csv"
} else {
    params.input = "$projectDir/input/manifests/crc_rnaseq.csv"
}
