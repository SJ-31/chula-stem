// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/TODO"
includeConfig "$projectDir/input/wes_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/TODO"
params.input = "$projectDir/input/manifests/???.csv"
