// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/CCA-RNASEQ"
includeConfig "$projectDir/input/rnaseq_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/CCA/RNASEQ"
if (params.debug) {
    params.input = "$projectDir/input/manifests/cca_rnaseq_DEBUG.csv"
} else {
    params.input = "$projectDir/input/manifests/cca_rnaseq.csv"
}
