// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/CCA-EXOME-TUMOR_ONLY"
includeConfig "$projectDir/input/wes_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/CCA/EXOME-TUMOR_ONLY"
params.logdir = "/data/project/stemcell/shannc/output/CCA/EXOME-TUMOR_ONLY/log"
params.input = "$projectDir/input/manifests/cca_exome_tumor_only.csv"
params.routine = "wes"
params.cohort = "D"
...
// params.ref.known_variants = params.ref.known_variants + gnomad_subsets
