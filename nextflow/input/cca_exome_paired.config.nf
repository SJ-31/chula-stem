// * Required params
workDir = "/data/project/stemcell/shannc/output/nf-work/CCA-EXOME-PAIRED"
includeConfig "$projectDir/input/wes_tools.config.nf"
params.outdir = "/data/project/stemcell/shannc/output/CCA/EXOME-PAIRED"
params.logdir = "/data/project/stemcell/shannc/output/CCA/EXOME-PAIRED/log"
params.input = "$projectDir/input/manifests/cca_exome_paired.csv"
params.routine = "wes"
params.cohort = "D"
